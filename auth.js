...
function registerUser(name, surname, email, username, password) {
    ...
    if (users.find(u => u.email === email)) {
        return { success: false, message: 'Bu email daxil olunub!' };
    }

    if (users.find(u => u.username === username)) {
        return { success: false, message: 'Bu istifadəçi adı artıq istifadə olunur!' };
    }
...
function loginUser(username, password) {
    ...
    return { success: false, message: 'İstifadəçi adı və ya parol səhvdir!' };
}
